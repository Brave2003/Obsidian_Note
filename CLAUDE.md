...
| `claude study/` | Learning notes for Claude Code source code (12 chapters, Chinese) |
...
`claude study/Learn-Claude-Source/` contains 12 chapters (`s01-agent-loop.md` through `s12-cli.md`) documenting Claude Code's architecture. These follow a consistent format:
